    ...
    return (
      <div className="planfooter">
        ...
        <div className="planfooter_popularity">
            ...
            <div><span className="checkicon"></span><span className="popularity_lowprice">Low Price Guarantee</span></div>
            <div><span className="checkicon"></span><span className="popularity_lowprice">No Booking Fees</span></div>
        </div>
      </div>
    );
  }
